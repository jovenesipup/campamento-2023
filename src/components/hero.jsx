...
export default function hero() {
  ...
  return (
    <div className="relative pt-20 lg:flex lg:container lg:pt-28 lg:pb-8 lg:justify-between">
      <div className="">
        <h1 className="hidden lg:block text-8xl text-slate-200 text-center font-bold">
        ...
        <div className="text-center">
          <Link to="/consulta">
            <button className="my-4 py-2 px-4 h-14 w-full font-bold uppercase text-dark-lila text-xl rounded-2xl border border-yellow bg-yellow shadow shadow-slate-50/10 lg:max-w-md">
              selecciona punto de partida
            </button>
          </Link>
        </div>
      </div>
      <div>
        ...
        <button
          id="play-button"
          className="hidden absolute z-20 top-0 bottom-0 right-[calc(50%-48px)] text-slate-50"
          ref={buttonPlay}
          onClick={handlePlayVideo}
        >
          <svg
