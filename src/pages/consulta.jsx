          ...
          <div>
              ...
              openBus && (
                <ModalBus>
                  ...
                  <h2 className="text-2xl font-bold">
                    Hola, {dataModal.nombre}
                  </h2>
                  <h4 className="text-lg ">
                    A continuación indícanos el punto de salida donde vas a
                    estar:
                  </h4>
                  <div className="pt-6">
                    {busPan < 147 && (
                    ...
                    {busSanta < 150 && (
                      ...
                      >
                        ...
                        <p className="text-sm">
                          Dirección: Avenida Los Virreyes 1526, Santa Anita
                          15011, Lima, Peru
                        </p>
                        <p className="text-sm w-full">
            ...
            <ModalConsulta>
              ...
              <div className="bg-dark-lila text-slate-50 rounded-lg p-4 shadow-sm shadow-dark-lila">
                ...
                <hr />
                <p className="text-md font-semibold mt-2 bg-yellow rounded-md text-dark-lila px-2">
                  Punto de partida:{" "}
                  <span className="first-letter:uppercase">
                    {(dataModal.weiPoint == "1" && "Pan de Vida") ||
                      (dataModal.weiPoint == "2" && "Santa Anita") ||
                      (dataModal.weiPoint == "3" && "Motupe") ||
                      "No definido"}
                  </span>
                </p>
              </div>
